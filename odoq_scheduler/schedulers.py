...
def start_scheduler():
    ...
    send_student_trigger = CronTrigger(day_of_week='mon-fri', hour=21, minute=58, second=10, jitter=3)
    send_author_trigger = CronTrigger(day_of_week='mon-fri', hour=21, minute=58, second=10, jitter=3)
